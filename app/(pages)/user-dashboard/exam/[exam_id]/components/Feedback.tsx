...
export default function FeedbackPage({ examId, userId, answers }) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-center mb-6">Exam Feedback</h2>
          ...
          <div key={index} className="p-6 bg-white rounded-xl shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <pre className="mt-2 whitespace-pre-wrap">{item.code}</pre>
              </div>
            ...
            <div className="mb-4">
              ...
              >
                Score: {item.points}/{item.maxPoints} points
                {item.isCorrect ? " ✅" : " ❌"}
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              {item.overallFeedback && (
                <div className="p-4 bg-gray-50 rounded-lg">
                  <h4 className="text-lg font-bold">📊 Overall Feedback:</h4>
